...
def train_and_evaluate_lstm(X_train_seq, Y_train_seq, X_test_seq, Y_test_eval, scaler_Y):
    ...
    predicted_series = pd.Series(predicted_price, index=Y_test_eval.index)
    return Y_test_eval, predicted_series, model
...
# ==============================================================================
# 3. XGBOOST OPTIMIZATION (Hyperparameter Tuning & Feature Importance)
# ==============================================================================
